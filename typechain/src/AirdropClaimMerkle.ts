...
export interface AirdropClaimMerkleInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    functionFragment: "merkleRoot_erc20",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "merkleRoot_erc721",
    values?: undefined
  ): string;
...
export interface AirdropClaimMerkle extends BaseContract {
  connect(runner?: ContractRunner | null): AirdropClaimMerkle;
  waitForDeployment(): Promise<this>;

  interface: AirdropClaimMerkleInterface;
  ...
  claimERC20: TypedContractMethod<
    [_recipient: AddressLike, _amount: BigNumberish, _proof: BytesLike[]],
    [void],
    "nonpayable"
  >;

  claimERC721: TypedContractMethod<
    [_recipient: AddressLike, _tokenId: BigNumberish, _proof: BytesLike[]],
    [void],
    "nonpayable"
  >;
  ...
  merkleRoot_erc20: TypedContractMethod<[], [string], "view">;

  merkleRoot_erc721: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "merkleRoot_erc20"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "merkleRoot_erc721"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
