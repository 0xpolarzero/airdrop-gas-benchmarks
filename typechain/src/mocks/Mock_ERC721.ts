...
export interface Mock_ERC721Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface Mock_ERC721 extends BaseContract {
  connect(runner?: ContractRunner | null): Mock_ERC721;
  waitForDeployment(): Promise<this>;

  interface: Mock_ERC721Interface;
