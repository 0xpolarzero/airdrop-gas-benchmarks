...
export interface AirdropClaimMappingInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "airdropERC20"
      | "airdropERC721"
  ...
  encodeFunctionData(
    functionFragment: "allowed_erc721",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
    functionFragment: "balances_erc20",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
    functionFragment: "balances_erc721",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export namespace AirdroppedERC20Event {
...
export namespace AirdroppedERC721Event {
...
export interface AirdropClaimMapping extends BaseContract {
  connect(runner?: ContractRunner | null): AirdropClaimMapping;
  waitForDeployment(): Promise<this>;

  interface: AirdropClaimMappingInterface;
  ...
  airdropERC721: TypedContractMethod<
    [_recipients: AddressLike[], _tokenIds: BigNumberish[]],
    [void],
    "nonpayable"
  >;

  allowed_erc721: TypedContractMethod<
    [account: AddressLike],
    [boolean],
    "view"
  >;

  balances_erc20: TypedContractMethod<[account: AddressLike], [bigint], "view">;

  balances_erc721: TypedContractMethod<
    [account: AddressLike],
    [bigint],
    "view"
  >;
  ...
  claimERC20: TypedContractMethod<[], [void], "nonpayable">;

  claimERC721: TypedContractMethod<[], [void], "nonpayable">;
  ...
  >;
  getFunction(
    nameOrSignature: "allowed_erc721"
  ): TypedContractMethod<[account: AddressLike], [boolean], "view">;
  getFunction(
    nameOrSignature: "balances_erc20"
  ): TypedContractMethod<[account: AddressLike], [bigint], "view">;
  getFunction(
    nameOrSignature: "balances_erc721"
  ): TypedContractMethod<[account: AddressLike], [bigint], "view">;
  getFunction(
  ...
  getEvent(
    ...
    AirdroppedERC20Event.InputTuple,
    AirdroppedERC20Event.OutputTuple,
    AirdroppedERC20Event.OutputObject
  >;
  getEvent(
    key: "AirdroppedERC721"
  ): TypedContractEvent<
    AirdroppedERC721Event.InputTuple,
    AirdroppedERC721Event.OutputTuple,
    AirdroppedERC721Event.OutputObject
  >;
  getEvent(
    key: "ClaimedERC20"
  ): TypedContractEvent<
  ...
  filters: {
    "AirdroppedERC20(address,uint256)": TypedContractEvent<
      AirdroppedERC20Event.InputTuple,
      AirdroppedERC20Event.OutputTuple,
      AirdroppedERC20Event.OutputObject
    >;
    AirdroppedERC20: TypedContractEvent<
      AirdroppedERC20Event.InputTuple,
      AirdroppedERC20Event.OutputTuple,
      AirdroppedERC20Event.OutputObject
    >;

    "AirdroppedERC721(address,uint256)": TypedContractEvent<
      AirdroppedERC721Event.InputTuple,
      AirdroppedERC721Event.OutputTuple,
      AirdroppedERC721Event.OutputObject
    >;
    AirdroppedERC721: TypedContractEvent<
      AirdroppedERC721Event.InputTuple,
      AirdroppedERC721Event.OutputTuple,
      AirdroppedERC721Event.OutputObject
    >;
